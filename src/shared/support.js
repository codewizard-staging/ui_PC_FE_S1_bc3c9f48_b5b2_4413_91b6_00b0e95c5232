...
fn.AddOrUpdatePetOwnerPets = async (input, excludesItems) => {
const numberItems_PetOwner = [  'OwnerId' ];
    return new Promise(async (resolve) => {
        let data = {}, status = false, id = null;
        global.Busy(true);
...
fn.AddOrUpdatePetCareCenterServices = async (input, excludesItems) => {
const numberItems_PetCareCenter = [  'PcId','Latitude','Longitude','Pincode' ];
    return new Promise(async (resolve) => {
        let data = {}, status = false, id = null;
        global.Busy(true);
...
fn.AddOrUpdatePetCareCenterPets = async (input, excludesItems) => {
const numberItems_PetCareCenter = [  'PcId','Latitude','Longitude','Pincode' ];
    return new Promise(async (resolve) => {
        let data = {}, status = false, id = null;
        global.Busy(true);
...
fn.AddOrUpdateManager = async (input, enums, excludesItems) => {
